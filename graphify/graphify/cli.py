# Modified from Graphify v0.9.64 for Second Brain memory integration.
...
def dispatch_command(cmd: str) -> None:
    if cmd == "provider":
        ...
        if ok:
            from graphify.memory_links import link_project_memories
            link_project_memories(watch_path)
